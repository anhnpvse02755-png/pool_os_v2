...
- "Scooping" - nâng đầu cơ khi đánh''',
    ...
    difficulty: DifficultyLevel.beginner,
    relatedKnowledgeIds: ['kn_stop_shot', 'kn_follow_shot'],
...
- Follow through quá ngắn''',
    ...
    difficulty: DifficultyLevel.beginner,
    relatedKnowledgeIds: ['kn_stop_shot', 'kn_draw_shot'],
...
3. Thực hành nhiều lần''',
    ...
    difficulty: DifficultyLevel.beginner,
    relatedKnowledgeIds: ['kn_aiming_fractional'],
...
- **Long safety**: Đẩy bi đối thủ ra xa''',
    ...
    relatedKnowledgeIds: ['kn_position_play'],
...
- Cánh tay tạo đường thẳng với cơ''',
    ...
    difficulty: DifficultyLevel.beginner,
    relatedKnowledgeIds: ['bridge.closed_bridge'],
    relatedDrillCodes: ['STRAIGHT_LV1'],
  ),
  KnowledgeItem(
    id: 'bridge.closed_bridge',
    slug: 'closed-bridge',
    title: 'Closed Bridge',
    titleVi: 'Gác cơ kín',
...
- Cần practice nhiều''',
    ...
    difficulty: DifficultyLevel.intermediate,
    relatedKnowledgeIds: ['bridge.open_bridge'],
    relatedDrillCodes: ['STRAIGHT_LV1', 'STRAIGHT_LV2'],
  ),
];
...
const drillKnowledgeMapping = {
  ...
  'DRAW_LV2': ['kn_draw_shot'],
  'DRAW_LV3': ['kn_draw_shot'],
  'FOLLOW_LV1': ['kn_follow_shot'],
  'FOLLOW_LV2': ['kn_follow_shot'],
  'FOLLOW_LV3': ['kn_follow_shot'],
  'STRAIGHT_LV1': ['kn_aiming', 'bridge.open_bridge'],
  'STRAIGHT_LV2': ['kn_aiming', 'kn_aiming_fractional', 'bridge.closed_bridge'],
  'SAFETY_LV1': ['kn_safety_play'],
  'SAFETY_LV2': ['kn_safety_play'],
  'POSITION_LV1': ['kn_position_play'],
  'POSITION_LV2': ['kn_position_play'],
  'POSITION_LV3': ['kn_position_play'],
};
