    ...
    DrillCategory(
      ...
      drills: [
        ...
        Drill(
          ...
          category: 'position',
          difficulty: 'medium',
          description: 'Học cách điều khiển bi cái đến vị trí mong muốn',
          setup: 'Đặt bi mục tiêu, điều khiển bi cái đến vùng',
          steps: [
            'Xác định vùng đích',
            'Tính lực và xoáy cần thiết',
            'Thực hiện cú đánh',
          ],
          goal: 'Bi cái dừng trong vùng chỉ định 7/10 lần',
          levels: [
            DrillLevel(level: 1, attempts: 10, passCount: 5, zone: '40cm'),
            DrillLevel(level: 2, attempts: 10, passCount: 6, zone: '30cm'),
            DrillLevel(level: 3, attempts: 10, passCount: 7, zone: '20cm'),
          ],
          knowledgeIds: ['position_play', 'spin_control', 'speed_control'],
        ),
        Drill(
          code: 'POSITION_TIGHT',
          name: 'Tight Position',
          nameVi: 'Position chặt',
          category: 'position',
          difficulty: 'hard',
          description: 'Điều bi cái đến vị trí rất gần bi mục tiêu',
          setup: 'Đặt bi mục tiêu sát lỗ',
          steps: [
            'Quan sát khoảng cách chính xác',
            'Tính lực cực nhẹ',
            'Kiểm soát bi cái dừng sát bi mục tiêu',
          ],
          goal: 'Bi cái dừng trong vùng 5cm 5/10 lần',
          levels: [
            DrillLevel(level: 1, attempts: 10, passCount: 3, zone: '8cm'),
            DrillLevel(level: 2, attempts: 10, passCount: 4, zone: '6cm'),
            DrillLevel(level: 3, attempts: 10, passCount: 5, zone: '5cm'),
          ],
          knowledgeIds: ['position_play', 'spin_control', 'delicate_control'],
        ),
      ],
    ),
    DrillCategory(
      ...
      drills: [
        ...
        Drill(
          code: 'SAFETY_KICK',
          name: 'Kick Safety',
          nameVi: 'An toàn đá bi',
          category: 'safety',
          difficulty: 'hard',
          description: 'Đánh safety khi bi cái không thể đánh thẳng',
          setup: 'Để bi cái và đối thủ cách nhau',
          steps: [
            'Xác định điểm đá',
            'Tính toán góc phản',
            'Điều khiển lực chính xác',
          ],
          goal: 'Đá bi đối thủ ra xa vùng dễ 5/10 lần',
          levels: [
            DrillLevel(level: 1, attempts: 10, passCount: 3),
            DrillLevel(level: 2, attempts: 10, passCount: 4),
            DrillLevel(level: 3, attempts: 10, passCount: 5),
          ],
          knowledgeIds: ['kick', 'safety', 'angles'],
        ),
        Drill(
          code: 'SAFETY_MASSÉ',
          name: 'Masse Safety',
          nameVi: 'An toàn masse',
          category: 'safety',
          difficulty: 'expert',
          description: 'Dùng masse để đánh safety khi cần',
          setup: 'Bi đối thủ gần băng',
          steps: [
            'Xác định điểm đánh masse',
            'Nâng đầu cơ cao',
            'Đánh mạnh và chính xác',
          ],
          goal: 'Tạo thế an toàn tốt 3/10 lần',
          levels: [
          ...
          knowledgeIds: ['masse', 'safety', 'english'],
        ),
      ],
    ),
    DrillCategory(
    ...
    DrillCategory(
      ...
      drills: [
        ...
        Drill(
          code: 'BREAK_ACCURACY',
          name: 'Break Accuracy',
          nameVi: 'Khai cuộc chính xác',
          category: 'break',
          difficulty: 'medium',
          description: 'Tập break chính xác vào vị trí mong muốn',
          setup: 'Đặt bi vào vị trí cố định',
          steps: [
            'Xác định điểm ngắm trên bi đối thủ',
            'Điều khiển lực vừa phải',
            'Follow through kiểm soát',
          ],
          goal: 'Phết bi vào vùng chỉ định 6/10 lần',
          levels: [
            DrillLevel(level: 1, attempts: 10, passCount: 4),
            DrillLevel(level: 2, attempts: 10, passCount: 5),
            DrillLevel(level: 3, attempts: 10, passCount: 6),
          ],
          knowledgeIds: ['break', 'aiming', 'accuracy'],
        ),
        Drill(
          code: 'BREAK_SPLIT',
          name: 'Break Split',
          nameVi: 'Khai cuộc chia bàn',
          category: 'break',
          difficulty: 'hard',
          description: 'Break để chia đều bi vào hai bên bàn',
          setup: 'Đặt bi 1 vào vị trí chuẩn',
          steps: [
            'Xác định điểm đánh trên bi 1',
            'Tính toán lực để chia bàn',
            'Follow through đầy đủ',
          ],
          goal: 'Ít nhất 3 bi mỗi bên bàn 5/10 lần',
          levels: [
            DrillLevel(level: 1, attempts: 10, passCount: 3),
            DrillLevel(level: 2, attempts: 10, passCount: 4),
            DrillLevel(level: 3, attempts: 10, passCount: 5),
          ],
          knowledgeIds: ['break', 'angles', 'power_control'],
        ),
      ],
    ),
    // ========================================================================
