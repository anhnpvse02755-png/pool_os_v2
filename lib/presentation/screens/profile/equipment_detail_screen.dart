            ...
            child: Column(
              ...
              children: [
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(value: 'tip_change', child: Text('Thay đầu cơ')),
                    DropdownMenuItem(value: 'rewrap', child: Text('Quấn lại cán')),
                    DropdownMenuItem(value: 'shaft_replacement', child: Text('Thay ngọn cơ')),
